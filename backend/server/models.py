...
def category_icon_upload_path(instance, filename):
    """Returns the path category for the icon to be uploaded"""
...
class Category(models.Model):
    ...
    def __str__(self):
        ...
        Returns:str: The name of the Category.
        """
        return f"{self.name}"
...
class Server(models.Model):
    ...
    def __str__(self):
        ...
        Returns: str: The formatted string with the name and ID of the Server.
        """
...
class Channel(models.Model):
    ...
    def __str__(self):
        ...
        Returns:str: The name of the Channel.
        """
        return self.name
